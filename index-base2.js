...
var Engrenagem = function (options) {
    ...
    this.image.src = options.image || 'base' + this.base + '.png';
    this.position = 0;
    this.angle = 0;
}
...
var Digito = function (options) {
    ...
    this.eng2 = new Engrenagem({ image: 'base.png', x: this.x - 80, y: this.y - 80, base: this.base });
...
$(document).ready(function () {
    ...
    Context.add(new Digito({ x: 50, y: 50, base:  2 }));
    Context.add(new Digito({ x: 250, y: 50, base: 2, digitoLeft: Context.objects[0] }));
    Context.add(new Digito({ x: 450, y: 50, base: 2, digitoLeft: Context.objects[1] }));
    Context.add(new Digito({ x: 650, y: 50, base: 2, digitoLeft: Context.objects[2] }));
    Context.play();
});